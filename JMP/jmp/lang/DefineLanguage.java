    ...
    static LangMap langMap = new LangMap() {
        {
            ...
            put(LangID.MIDI_device_settings, new LanguageWords("MIDI Device settings","MIDIデバイス設定","MIDI设备设置","MIDI 設備設置","MIDI 장치 설정","Настройки MIDI-устройства"));
            put(LangID.Open_MIDI_device_settings_on_startup, new LanguageWords("Open MIDI device settings on startup","起動時にMIDIデバイス設定を開く","启动时打开MIDI设备设置","啟動時打開 MIDI 設備設置","시작 시 MIDI 장치 설정 열기","Открывать настройки MIDI-устройства при запуске"));
            ...
            put(LangID.MIDI_message_monitor, new LanguageWords("MIDI Message monitor","MIDIメッセージモニター","MIDI信息监视器","MIDI 信息監視器","MIDI 메시지 모니터","Монитор сообщений MIDI"));
            put(LangID.MIDI_message_sender, new LanguageWords("MIDI Message sender","MIDIメッセージ送信","MIDI信息发送者","MIDI 信息發送器","MIDI 메시지 발신자","Отправитель MIDI-сообщений"));
            ...
            put(LangID.FILE_ERROR_1, new LanguageWords("※Other files cannot be loaded while loading a file.","※ファイルロード中に他のファイルをロードできません。","※加载文件时无法加载其他文件。","※加載文件時無法加載其他文件。","※파일 불러오기 중에는 다른 파일을 불러올 수 없습니다.","※ Другие файлы не могут быть загружены во время загрузки файла."));
            put(LangID.FILE_ERROR_2, new LanguageWords("※File format not supported.","※サポート外のファイル形式です","※不支持文件格式。","※不支持文件格式。","※파일 형식은 지원하지 않습니다.","※ Формат файла не поддерживается."));
            put(LangID.FILE_ERROR_3, new LanguageWords("※Files cannot be loaded during playback.","※再生中はファイルロードできません。","※播放过程中无法加载文件。","※播放過程中無法加載文件。","※재생 중에는 파일을 불러올 수 없습니다.","※ Файлы не могут быть загружены во время воспроизведения."));
            put(LangID.FILE_ERROR_4, new LanguageWords("※The file cannot be opened.","※ファイルを開くことができません。","※文件无法打开。","※無法打開文件。","※파일을 열 수 없습니다.","※ Файл не открывается."));
            put(LangID.FILE_ERROR_5, new LanguageWords("※Failed to load the file.","※ファイルのロードに失敗しました。","※无法加载文件。","※加載文件失敗。","※파일 불러오기에 실패했습니다.","※ Не удалось загрузить файл."));
            put(LangID.FILE_ERROR_6, new LanguageWords("※There is no data to play.","※再生するデータがありません。","※没有数据可玩。","※沒有數據可玩。","※재생할 데이터가 없습니다.","※ Нет данных для воспроизведения."));
            put(LangID.FILE_LOAD_SUCCESS, new LanguageWords("File loading successful.","ファイルロード成功","文件加载成功。","文件加載成功。","파일 로드에 성공했습니다.","Файл загружен успешно."));
            put(LangID.PLUGIN_LOAD_SUCCESS, new LanguageWords("Plugin loading successful.","プラグインロード成功","插件加载成功。","插件加載成功。","플러그인 로드에 성공했습니다.","Плагин загружается успешно."));
            put(LangID.PLUGIN_LOAD_ERROR, new LanguageWords("Plugin loading failed.","プラグインロード失敗","插件加载失败。","插件加載失敗。","플러그인 로드에 실패했습니다.","Ошибка загрузки плагина."));
            ...
            put(LangID.Open_with_Explorer, new LanguageWords("Open with Explorer","エクスプローラで開く","用资源管理器打开","用資源管理器打開","탐색기로 열기","Открыть с помощью проводника"));
            put(LangID.MIDI_Data_byte, new LanguageWords("MIDI Data byte（Hex）","MIDIデータバイト（Hex）","MIDI数据字节（十六进制）","MIDI 數據字節（Hex）","MIDI 데이터 바이트(16진수)","Байт данных MIDI (шестнадцатеричный)"));
            put(LangID.Send, new LanguageWords("Send","送信","发送","發送","보내다","Отправлять"));
            put(LangID.Invalid_byte_data, new LanguageWords("Invalid byte data","無効なバイトデータ","无效的字节数据","無效的字節數據","잘못된 바이트 데이터","Недействительные байтовые данные"));
            ...
            put(LangID.Copied_to_clipboard, new LanguageWords("Copied to clipboard.","クリップボードにコピーしました。","复制到剪贴板。","複製到剪貼板。","클립보드에 복사했습니다.","Скопировано в буфер обмена."));
            ...
            put(LangID.FFmpeg_converter, new LanguageWords("Audio file conversion(FFmpeg)","音声ファイル変換（FFmpeg）","音频文件转换 (FFmpeg)","音頻文件轉換(FFmpeg)","오디오 파일 변환(FFmpeg)","Конвертация аудиофайлов (FFmpeg)"));
            put(LangID.FFmpeg_path, new LanguageWords("FFmpeg path(.exe)","FFmpeg実行ファイル(.exe)","FFmpeg路径（.exe）","FFmpeg 路徑（.exe）","FFmpeg 경로(.exe)","Путь FFmpeg (.exe)"));
            ...
            put(LangID.A_is_invalid, new LanguageWords("[NAME] is invalid.","[NAME]が無効です。","[NAME]无效。","[NAME] 無效。","[NAME]이(가) 잘못되었습니다.","[ИМЯ] недействителен."));
            put(LangID.Conversion_failed, new LanguageWords("Conversion failed.","変換失敗。","转换失败。","轉換失敗。","변환에 실패했습니다.","Преобразование не выполнено."));
            put(LangID.Conversion_completed, new LanguageWords("Conversion completed.","変換完了。","转换完成。","轉換完成。","변환이 완료되었습니다.","Преобразование завершено."));
            ...
            put(LangID.Use_FFmpeg_player, new LanguageWords("Use FFmpeg player","FFmpegプレイヤー使用","使用FFmpeg播放器","使用 FFmpeg 播放器","FFmpeg 플레이어 사용","Используйте проигрыватель FFmpeg"));
            put(LangID.Automatically_assign_MIDI_channel, new LanguageWords("Automatically assign MIDI channel","「MIDIチャンネル」を自動的に割り当てる","自动分配MIDI通道","自動分配 MIDI 通道","자동으로 MIDI 채널 할당","Автоматически назначать MIDI-канал"));
            put(LangID.Automatically_assign_Program_change_number, new LanguageWords("Automatically assign Program change number","「プログラムチェンジ」を自動的に割り当てる","自动分配程序更改号","自動分配程序更改編號","프로그램 변경 번호 자동 할당","Автоматически присвоить номер изменения программы"));
            put(LangID.Confirm_jms_with_different_versions, new LanguageWords("There are plugins with different versions. Do you want to load it?","バージョンが異なるプラグインが存在します。ロードしますか？","有不同版本的插件。是否要加载？","有不同版本的插件。你想加載它嗎？","버전이 다른 플러그인이 있습니다. 로드하시겠습니까?","Есть плагины с разными версиями. Вы хотите его загрузить?"));
            put(LangID.Confirm_jmz_with_different_versions, new LanguageWords("The version of the plugin you are trying to add is different. Do you want to add it?","追加しようとしているプラグインのバージョンが異なります。追加しますか？","您尝试添加的插件版本不同。 您要添加吗？","您嘗試添加的插件版本不同。您要添加它嗎？","추가하려는 플러그인의 버전이 다릅니다. 추가하시겠습니까?","Версия плагина, которую вы пытаетесь добавить, отличается. Вы хотите его добавить?"));
            put(LangID.D_and_D_the_playback_file_here, new LanguageWords("Drag and drop the playback file here.","再生ファイルをここにドラッグ&ドロップしてください。","将播放文件拖放到此处。","將播放文件拖放到此處。","재생 파일을 여기에 끌어다 놓습니다.","Перетащите сюда файл воспроизведения."));
            ...
            put(LangID.Send_system_setup_before_playback, new LanguageWords("Send system setup before playback","再生前にシステムセットアップを送信する","播放前发送系统设置","播放前發送系統設置","재생 전에 시스템 설정 보내기","Отправить настройки системы перед воспроизведением"));
            put(LangID.Whether_to_display_every_time_at_startup, new LanguageWords("Whether to display every time at startup","起動時に毎回表示するか","是否在每次启动时显示","是否每次啟動都顯示","시작할 때마다 표시할지 여부","Отображать ли каждый раз при запуске"));
            ...
            put(LangID.Send_system_setup, new LanguageWords("Send system setup","システムセットアップ送信","发送系统设置","發送系統設置","시스템 설정 보내기","Отправить настройки системы"));
            put(LangID.Automatic_selection, new LanguageWords("Automatic selection","自動選択","自动选择","自動選擇","자동 선택","Автоматический выбор"));
            put(LangID.Builtin_synthesizer, new LanguageWords("Built-in synthesizer","内蔵シンセサイザー","Built-in synthesizer","內置合成器","내장 신디사이저","Встроенный синтезатор"));
            put(LangID.Builtin_synthesizer_settings, new LanguageWords("Built-in synthesizer settings","内蔵シンセサイザー設定","Built-in synthesizer settings","內置合成器設置","내장 신디사이저 설정","Встроенные настройки синтезатора"));
            put(LangID.An_unexpected_error_has_occurred, new LanguageWords("An unexpected error has occurred.","予期しないエラーが発生しました。","发生意外的错误。","發生意外的錯誤。","예상치 못한 오류가 발생했습니다.","Произошла непредвиденная ошибка."));
            put(LangID.Exit_the_application, new LanguageWords("Exit the application.","アプリケーションを終了します。","退出应用程序。","退出應用程序。","응용 프로그램을 종료합니다.","Выйти из приложения."));
            put(LangID.There_was_a_problem_preparing_the_music_player, new LanguageWords("There was a problem preparing the music player.","音楽プレイヤーの準備に問題が発生しました。","准备音乐播放器时出现问题。","準備音樂播放器時出現問題。","뮤직 플레이어를 준비하는 중에 문제가 발생했습니다.","Не удалось подготовить музыкальный проигрыватель."));
            put(LangID.Failed_to_initialize_the_application, new LanguageWords("Failed to initialize the application.","アプリケーションの初期化処理に失敗しました。","无法初始化应用程序。","未能初始化應用程序。","애플리케이션을 초기화하지 못했습니다.","Не удалось инициализировать приложение."));
            put(LangID.The_application_could_not_be_terminated_successfully, new LanguageWords("The application could not be terminated successfully.","アプリケーションを正常に終了できませんでした。","无法成功终止该应用程序。","無法成功終止應用程序。","응용 프로그램을 성공적으로 종료할 수 없습니다.","Приложение не может быть успешно завершено."));
            ...
            put(LangID.Enable_Video_Player, new LanguageWords("Enable video player","動画プレイヤーの有効化","启用视频播放器","啟用影片播放器","동영상 플레이어 사용","Включить видеоплеер"));
            put(LangID.Image_Quality, new LanguageWords("Quality","画質","图像质量","影像品質","화질","Качество изображения"));
            put(LangID.Video_Setting, new LanguageWords("Video Settings","動画設定","视频设置","影片設定","동영상 설정","Настройки видео"));
        }
    };
}
